        ...
        <Container>
          <div className="relative max-w-md">
            ...
            <input
              ...
              className="w-full rounded-xl bg-white py-4 pr-4 pl-12 text-sm text-ink-900 placeholder:text-slate-400 focus:ring-2 focus:ring-mint-200 focus:outline-none"
            />
          </div>
        </Container>
      </div>
